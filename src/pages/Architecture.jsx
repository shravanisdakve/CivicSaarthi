...
const CORE_SERVICES = [
  ...
  },
  {
    ...
    desc: 'Powers the core intelligence of CivicSaarthi. This highly efficient and cost-effective model handles complex natural language queries about electoral processes, translates official jargon into accessible guidance, and generates context-aware responses while maintaining a strict non-partisan persona.',
    ...
    <div className="max-w-screen-xl mx-auto px-6 md:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-on-surface-variant max-w-2xl mx-auto">
          CivicSaarthi leverages enterprise-grade Google Cloud services to ensure high availability,
          security, and real-time AI assistance for voters.
        </p>
      </div>

      {/* System Architecture Diagram */}
      <div className="mb-16">
        <h2 className="font-['Public_Sans'] text-2xl font-bold text-on-surface mb-6">
          System Architecture
        </h2>
          ...
          <div className="min-w-[600px] flex items-center justify-center gap-6">
            ...
            <div className="text-center flex flex-col items-center">
              <div className="w-24 h-24 rounded-2xl bg-primary-fixed border border-primary-fixed-dim flex items-center justify-center mb-3">
                <span className="material-symbols-outlined text-primary text-4xl icon-fill">
                  cloud
                </span>
              </div>
            ...
            <div className="flex flex-col items-center px-4 gap-2">
              <div className="bg-green-100 text-green-700 text-[10px] font-bold px-2 py-1 rounded-full whitespace-nowrap">
                Knowledge Matcher
              </div>
              <span className="material-symbols-outlined text-slate-400">arrow_forward</span>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {CORE_SERVICES.map((s, idx) => (
            <Card key={idx} className="p-6 md:p-8 bg-surface-container-low border-0" hover={false}>
              ...
              <h3 className="font-['Public_Sans'] text-xl font-bold text-on-surface mb-3">
                {s.title}
              </h3>
