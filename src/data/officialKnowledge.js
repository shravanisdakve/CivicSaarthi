export const officialKnowledge = [
  {
    ...
    summary: "Any Indian citizen aged 18 or above can register as a general voter using Form 6 through the official Voter Service Portal.",
    steps: [
  ...
  },
  {
    ...
    summary: "VVPAT (Voter Verifiable Paper Audit Trail) is a system that lets voters visually verify their vote through a printed slip shown briefly behind a transparent window.",
    steps: [
  ...
  },
  {
    ...
    category: "Identity",
    summary: "EPIC is the Electoral Photo Identity Card issued by the ECI. It serves as identity and residence proof for voting.",
    steps: [
    ...
    officialReminder: "Possession of EPIC does not guarantee the right to vote; your name must be in the electoral roll.",
  ...
  },
  {
    ...
    summary: "MCC is a set of guidelines issued by the ECI for political parties and candidates to ensure free and fair elections.",
    steps: [
  ...
  },
  {
    ...
    summary: "cVIGIL is an app for citizens to report Model Code of Conduct violations by political parties or candidates.",
    steps: [
  ...
  },
  {
    ...
    category: "Voting Day",
    summary: "A polling station is the designated building where voters cast their ballots. It is typically a school or government office near your residence.",
    steps: [
  ...
  },
  {
    ...
    summary: "NOTA allows voters to express that they do not support any of the candidates in the fray.",
    steps: [
  ...
  },
  {
    ...
    summary: "KYC app allows voters to check the criminal antecedents and assets of candidates contesting elections.",
    steps: [
  ...
  },
  {
    ...
    category: "Safety",
    summary: "Election misinformation can mislead voters about polling dates, candidates, or processes. Always verify through official channels.",
    steps: [
    ...
    officialReminder: "Critical details should only be trusted if verified by the Election Commission.",
  ...
  },
  {
    ...
    category: "Voting Technology",
    summary: "EVM is a tamper-proof electronic device used to record votes. It consists of a Control Unit and a Ballot Unit.",
    steps: [
    ...
    officialReminder: "EVMs are secure and subjected to multi-level mock polls before actual voting.",
    sourceName: "Election Commission of India",
    sourceUrl: "https://www.eci.gov.in/"
  },
  {
    ...
    summary: "Nomination is the formal process of a candidate filing papers to contest an election.",
    steps: [
  ...
  },
  {
    ...
    category: "Electoral Process",
    summary: "Counting of votes happens on a designated day at secure counting centers under strict supervision.",
    steps: [
