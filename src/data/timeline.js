export const timelineStages = [
  {
    ...
    date: 'Phase 1',
    shortDesc: 'The Election Commission officially announces the schedule, starting the democratic journey.',
    detail: 'The ECI releases an official press note announcing election dates for all phases. This marks the formal start of the election process across the country.',
    keyPoints: [
  ...
  },
  {
    ...
    date: 'Phase 1 – Active',
    shortDesc: 'Guidelines issued by ECI to regulate political parties and ensure a level playing field.',
    detail: 'The Model Code of Conduct (MCC) comes into effect immediately after the announcement. it ensures that political parties and candidates behave ethically and that the ruling party does not misuse official machinery.',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'Candidates submit their formal applications (nomination papers). They must also disclose assets, education, and criminal records via an affidavit (Form 26).',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'The Returning Officer examines every nomination to ensure they are legally valid and complete. Candidates can raise objections during this time.',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'Candidates who have been declared valid have a fixed time window to withdraw their names if they choose not to contest.',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'Candidates and parties engage in rallies and outreach. Campaigning ends 48 hours before polling (Silence Period).',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'Registered voters cast their votes in a secure environment. EVMs and VVPATs are used for transparency.',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'EVMs are opened and votes are counted in the presence of candidates and their agents at counting centers.',
    keyPoints: [
  ...
  },
  {
    ...
    detail: 'After counting, the Returning Officer officially declares the winner and issues a Certificate of Election.',
    keyPoints: [
