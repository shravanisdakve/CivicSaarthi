const NOTIFICATIONS = [
  {
    id: 1,
    text: 'Verify your polling station from official sources.',
    type: 'info',
    icon: 'location_on',
  },
  {
    id: 2,
    text: 'Review what to carry on polling day (EPIC, Voter Slip).',
    type: 'warning',
    icon: 'shopping_bag',
  },
  ...
  {
    id: 4,
    text: 'Check official sources before trusting forwarded messages.',
    type: 'error',
    icon: 'security',
  },
];
    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="divide-y divide-slate-100">
        {NOTIFICATIONS.map((n) => (
          <div
            key={n.id}
            className="p-4 hover:bg-slate-50 transition-colors flex gap-3 items-start"
          >
            <span
