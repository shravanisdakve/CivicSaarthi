...
export default function LanguageToggle() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-32 bg-white rounded-xl shadow-card border border-slate-200 overflow-hidden z-50 animate-in fade-in slide-in-from-top-1 duration-200" role="listbox">
          {LANGUAGES.map((lang) => (
            <button
              key={lang.code}
              role="option"
