      ...
      {isOpen && (
        <div className="mb-4 w-[350px] sm:w-[400px] h-[550px] bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="bg-gradient-to-r from-primary to-indigo-700 p-4 text-white flex items-center justify-between shadow-lg">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="absolute -top-8 right-0 bg-slate-800 text-[8px] text-white px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  Clear Chat
                </span>
              </button>
              <button
          ...
          >
            ...
            {!isJourneyActive && (
              <div className="bg-gradient-to-br from-primary/5 to-indigo-50 border border-primary/10 rounded-xl p-4 shadow-sm mb-4">
                ...
                <p className="text-[10px] text-slate-600 mb-3">
                  Learn the full election process one step at a time.
                </p>
                <button
            ...
            {messages.map((msg, i) => (
              ...
              >
                      ...
                      {msg.references && msg.references.length > 0 && (
                        <div className="space-y-2">
                          {msg.references.slice(0, 2).map((ref, idx) => (
                            <div
                              key={idx}
                              className="flex justify-between items-center bg-green-50/50 p-1.5 rounded-lg border border-green-100/50"
                            >
                              <span className="text-[9px] font-semibold text-green-800 truncate max-w-[120px]">
                                {ref.title}
                              </span>
                              {ref.sourceUrl && (
                                <a
                ...
                {msg.role === 'ai' && (
                  <span className="text-[8px] text-slate-400 mt-1 ml-1 px-1">
          ...
          <div className="p-4 bg-white border-t border-slate-100">
            ...
            {validationError && (
              <p className="text-[10px] text-red-600 font-bold mb-2 animate-pulse">
                {validationError}
              </p>
            )}
            {privacyWarning && (
        ...
        <button
          ...
          className={`w-16 h-16 rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 overflow-hidden border-2 focus:ring-4 focus:ring-primary/20 outline-none ${
            isOpen
              ...
              : 'bg-white border-primary shadow-[0_0_20px_rgba(26,35,126,0.3)]'
          }`}
